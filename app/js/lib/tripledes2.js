...
*/
var TCBSCryptoJS = TCBSCryptoJS || function (u, l) {
...
(function () {
    var u = TCBSCryptoJS, l = u.lib.WordArray;
    u.enc.Base64 = {
...
(function (u) {
    ...
    for (var s = TCBSCryptoJS, q = s.lib, w = q.WordArray, v = q.Hasher, q = s.algo, b = [], x = 0; 64 > x; x++) b[x] = 4294967296 * u.abs(u.sin(x + 1)) | 0;
    q = q.MD5 = v.extend({
        _doReset: function () {
...
(function () {
    var u = TCBSCryptoJS, l = u.lib, d = l.Base, n = l.WordArray, l = u.algo, p = l.EvpKDF = d.extend({
...
TCBSCryptoJS.lib.Cipher || function (u) {
    var l = TCBSCryptoJS, d = l.lib, n = d.Base, p = d.WordArray, s = d.BufferedBlockAlgorithm, q = l.enc.Base64,
...
(function () {
    ...
    var d = TCBSCryptoJS, n = d.lib, p = n.WordArray, n = n.BlockCipher, s = d.algo,
